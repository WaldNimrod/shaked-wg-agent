---
id: ROUTING_TEAM190_S005-P005-WP002_L-GATE_S
from: Team 110
...
# Routing: Team 190 | L-GATE_S | S005-P005-WP002 | Round #1
...
3. _COMMUNICATION/team_190/MANDATE_S005-P005-WP002_L-GATE_S_v1.0.0.md — your gate mandate (read last)
...
FIRST ACTION: Read _aos/governance/team_190.md, then _aos/roadmap.yaml, then the mandate at _COMMUNICATION/team_190/MANDATE_S005-P005-WP002_L-GATE_S_v1.0.0.md.

Then read the spec artifact: _aos/work_packages/S005-P005-WP002/LOD200_S005-P005-WP002.md
And reference files:
...
Verdict (write here): _COMMUNICATION/team_190/VERDICT_S005-P005-WP002_L-GATE_S_v1.0.0.md
```
