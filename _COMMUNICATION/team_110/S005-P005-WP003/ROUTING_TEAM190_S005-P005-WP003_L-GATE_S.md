---
id: ROUTING_TEAM190_S005-P005-WP003_L-GATE_S
from: Team 110
...
# Routing: Team 190 | L-GATE_S | S005-P005-WP003 | Round #1
...
3. _COMMUNICATION/team_190/MANDATE_S005-P005-WP003_L-GATE_S_v1.0.0.md — your gate mandate (read last)
...
- Track: A | LOD: LOD200
- Prior gates: none (first gate)
- Depends on: S005-P005-WP002 (reuses LLM parser)

## Your Task
Execute the L-GATE_S mandate. Validate all criteria independently.
Do NOT read other teams' conclusions before forming your verdict.
Cross-engine rule: builder engine (cursor-composer) != validator engine (openai).

FIRST ACTION: Read _aos/governance/team_190.md, then _aos/roadmap.yaml, then the mandate at _COMMUNICATION/team_190/MANDATE_S005-P005-WP003_L-GATE_S_v1.0.0.md.

Then read the spec artifacts:
- _aos/work_packages/S005-P005-WP003/LOD200_S005-P005-WP003.md (primary)
- _aos/work_packages/S005-P005-WP002/LOD200_S005-P005-WP002.md (dependency — WP002 LLM parser)
And reference files:
- shaked_wg_agent/scrapers/base.py (BaseScraper interface)
- data/sources.json (source registry)

Verdict (write here): _COMMUNICATION/team_190/VERDICT_S005-P005-WP003_L-GATE_S_v1.0.0.md
```
