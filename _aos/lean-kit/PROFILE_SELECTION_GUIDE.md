...
## L2.5 — Managed Agent Pipeline (RETIRED)

L2.5 is **retired as of v4.0.0**, replaced by the **MANAGED track** for WP classification (ADR044 §4) — see
`governance/directives/ADR044_AOS_v4_0_0_CHARTER_AND_TRACK_MODEL_v1.0.0.md`. Its governance intent (human
gates for high-risk, multi-team work) is fully absorbed by MANAGED's `HG-1`/`HG-2` human gates.

All L2.5-era documentation (orchestrator runbook, quick reference, LOD100 form, activation prompts) is
historical reference at `_archive/lean-kit-L2.5/`. No active spoke runs L2.5; do not activate it for new WPs.
...
| L2.5 profile (retired) | `lean-kit/profiles/L2.5.yaml` |
| L2.5 quick reference (archived) | `_archive/lean-kit-L2.5/L25_QUICK_REFERENCE.md` |
| L2.5 orchestrator runbook (archived) | `_archive/lean-kit-L2.5/runbooks/ORCHESTRATOR_RUNBOOK.md` |
| L2.5 LOD100 form (archived) | `_archive/lean-kit-L2.5/artifacts/LOD100_L25_FORM.md` |
