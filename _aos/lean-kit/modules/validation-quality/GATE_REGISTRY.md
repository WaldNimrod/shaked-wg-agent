...
|-------|------|-------------|-------------------|-------|----------------|
| 1 | L-GATE_ELIGIBILITY | LOD100 | Constitutional (team_90) | `/AOS_validate` | PASS / FAIL |
| 2 | L-GATE_SPEC | LOD200 + LOD400 | Constitutional (team_90) | `/AOS_validate` | PASS / PASS_WITH_FINDINGS / FAIL |
| 3 | L-GATE_BUILD | LOD400 + impl | QA (team_50) + Tech (team_90) | `/AOS_qa` + `/AOS_validate` | PASS / FAIL |
| 4 | L-GATE_VALIDATE | LOD400 + L-GATE_BUILD PASS | Constitutional (team_90) | `/AOS_validate` | PASS / PASS_WITH_FINDINGS / FAIL |
...
| 3 | L-GATE_SPEC | LOD300 + LOD400 | Constitutional (team_90) | `/AOS_validate` | PASS / PASS_WITH_FINDINGS / FAIL |
| 4 | L-GATE_BUILD | LOD400 + impl | QA (team_50) + Tech (team_90) | `/AOS_qa` + `/AOS_validate` | PASS / FAIL |
| 5 | L-GATE_VALIDATE | LOD400 + L-GATE_BUILD PASS | Constitutional (team_90) | `/AOS_validate` | PASS / PASS_WITH_FINDINGS / FAIL |
...
| Order | Gate | LOD Required | Validator Authority | Skill | Verdict Options |
|-------|------|-------------|-------------------|-------|----------------|
| 1 | GATE_0 | LOD100 | Constitutional (team_90) | `/AOS_validate` | PASS / FAIL |
...
| 6 | GATE_5 | LOD500 | Constitutional (team_90) | `/AOS_validate` | PASS / PASS_WITH_FINDINGS / FAIL |
...
|-------|-----------|------|-----------|-------|----------------|
| 1 | EXT-CP1 | Advisory (always) | Constitutional (team_90) | `/AOS_validate` | CLEAR / CONCERNS / BLOCKED |
...
| 7 | EXT-CP2 | Advisory (risk-conditioned) | Constitutional (team_90) | `/AOS_validate` | CLEAR / CONCERNS / BLOCKED |
...
- Target team is validator authority (team_90, or equivalent)
...
| L-GATE_VALIDATE | Validator engine != builder engine (different vendor) | Team 90 must be a different LLM vendor than the builder |
| L-GATE_BUILD (Tech) | Tech validator != builder engine | Read from team_assignments.yaml |
| EXT-CP1/CP2 | Cross-vendor mandatory | Validator is a different vendor than builders (team_90 = Cursor, or team_70 = codex/OpenAI) |
...
**Complete AOS command name index (Tier 1 + Tier 2, ADR031):** `/AOS_archive`, `/AOS_decide`, `/AOS_dispatch`, `/AOS_domain-health`, `/AOS_gate-mandate`, `/AOS_gate-status`, `/AOS_gov-sync`, `/AOS_gov-update`, `/AOS_handoff`, `/AOS_help`, `/AOS_mail`, `/AOS_onboard`, `/AOS_project-init`, `/AOS_qa`, `/AOS_send` *(deprecated → `/AOS_SendMail`)*, `/AOS_SendMail`, `/AOS_session`, `/AOS_server`, `/AOS_validate`.
