...
> **SUPERSEDED by v2.0.0** (`TEAM_50_E2E_STANDARD_v2.0.0.md`, 2026-06-17, AOS-V5-M5-WP3). v2 absorbs
> this E2E-evidence rule verbatim (§6) and adds the four QA-deepening axes (Q-D1..Q-D4). Use v2.
