...
| `docs/TEAM_50_E2E_STANDARD_v2.0.0.md` | Binding team_50 QA standard: 4 QA-deepening axes (Q-D1..Q-D4) + the E2E evidence rule. Supersedes v1.0.0. |
...
3. Read `docs/TEAM_50_E2E_STANDARD_v2.0.0.md` — the binding team_50 QA standard (QA-deepening axes + when Team 50 will require E2E evidence in QA_REQUEST)
