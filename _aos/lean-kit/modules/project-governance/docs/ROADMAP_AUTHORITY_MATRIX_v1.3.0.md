...
version: 1.3.0
status: ACTIVE
supersedes: ROADMAP_AUTHORITY_MATRIX_v1.2.0.md
authority: team_00 (approval) + team_100 (author)
date: 2026-07-26
trigger: ROADMAP_AUTHORITY_MATRIX Batch-2 #8 — team_191 → team_120 (Ambassador)
change_log:
  ...
  - v1.3.0: Column `team_191` replaced by `team_120` (Ambassador). Bootstrap/propagate ✅ retained under team_120 (inherits team_191 ambassador role per D-191auth). ROADMAP_INSERTION_REQUEST ✅ retained (ambassador may file). All other action rows remain ❌ — team_120 does not gain roadmap mutation authority. (2026-07-26)
---

# Roadmap Authority Matrix v1.3.0
...
**v1.3.0 note:** `team_191` is retired. The bootstrap/propagate role that lived under team_191 is now **team_120 (Ambassador)** per D-191auth. This is a role-judged remap, not a blind column rename — only ambassador-fit cells carry ✅.

---

## Authority Table (v1.3.0)

| Action | Track | Effort | Sprint Cap | team_00 | team_100 (hub repo) | team_100 (spoke repo) | team_120 (Ambassador) | team_110 | all other teams |
|--------|-------|--------|:----------:|:-------:|:-------------------:|:---------------------:|:---------------------:|:--------:|:---------------:|
...
**team_120 (Ambassador)** — Governance propagation / GCR / drift-audit / DOC_CANON. Inherits team_191's `_aos/` write authority for bootstrap and propagate (D-191auth). Does **not** hold roadmap mutation authority (add/patch/defer/cancel/track/effort/sprint). May file `ROADMAP_INSERTION_REQUEST` like any team.
...
- `_aos/governance/` snapshots are READ-ONLY in spokes — propagated by hub only (team_120 Ambassador under mandate).
...
- **team_120** may bootstrap/propagate `_aos/` sync; may **not** mutate roadmap operational state, Track, Effort, or Sprint cap.
...
*Authored by team_100 (Batch-2 #8; engine: cursor) — 2026-07-26*
