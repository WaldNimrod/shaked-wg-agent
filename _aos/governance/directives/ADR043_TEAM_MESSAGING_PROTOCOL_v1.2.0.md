...
version: "1.2.0"
status: APPROVED
author: Team 170 (Domain Architecture, advisory) / Team 20 (implementation) / Team 110 (v1.1, v1.2 amendments)
approved_by:
  - team_00
  - team_100
  - team_110
...
amended: "2026-04-25"
supersedes: ADR043_TEAM_MESSAGING_PROTOCOL_v1.1.0
adr_ref: ADR-043
wp_ref: AOS-V327-WP-TEAM-MESSAGING (v1.0.0) / AOS-MSG-BRANCH-INDEPENDENCE-WP001 (v1.1.0) / AOS-MSG-DOMAIN-ROUTING-FIX (v1.2.0 §6) / AOS-MSG-FOLLOWUPS-WP001 (v1.2.0 §6 + §7 archive)
---
