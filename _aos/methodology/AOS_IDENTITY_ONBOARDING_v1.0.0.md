...
| Governance propagation / archive custodian | `team_120` | `_aos/` bootstrap + propagation + post-gate-archive custodianship under mandate — inherited from the **dissolved `team_191`** (Git/Files, dissolved 2026-07-05, D-191auth); git ops → `team_60`, archival exec → `/AOS_archive` (`archive.py`) |
