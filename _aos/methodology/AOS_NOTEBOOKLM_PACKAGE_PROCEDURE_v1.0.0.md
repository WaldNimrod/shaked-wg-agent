...
| `methodology/lod-standard/LOD_STANDARD_v5.md` | — | ✓ | ✓ |
...
<!-- v5.1.1 cleanup: dropped 2 rows for now-archived sources --
     lean-kit/modules/managed-pipeline/L25_QUICK_REFERENCE.md -> _archive/lean-kit-L2.5/L25_QUICK_REFERENCE.md
     core/ui/guides/*.html -> _archive/agents_os_v3_ui/guides/*.html
     Both retired; no longer live sources for package generation. -->
...
### §3.5 — HTML Guide Extraction Rules (rules retained for reference; source archived in v5.1.1 cleanup)

`core/ui/guides/*.html` was archived to `_archive/agents_os_v3_ui/guides/` (v5.1.1 cleanup, superseded by
cockpit CK-6 help) and is no longer a live source. These extraction rules are kept in case a similar
HTML-guide source is added in the future.

When extracting content from an HTML guide source:
