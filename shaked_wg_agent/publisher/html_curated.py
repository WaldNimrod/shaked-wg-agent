          ...
          <template x-for="l in sortedListings()" :key="'m-'+l.id">
            <tr class="border-t border-stone-100 hover:bg-blue-50/30">
              <td class="p-2 sticky right-0 bg-white border-l border-stone-200">
                <a :href="l.url" target="_blank" class="font-semibold text-slate-900 hover:text-blue-700 text-xs" x-text="l.title.substring(0,40)"></a>
                <div class="text-[10px] text-slate-500" x-text="l.district || l.location"></div>
              </td>
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-baseline gap-2 mb-1">
                <span class="text-xs font-semibold text-slate-400" x-text="`#${{i+1}}`"></span>
